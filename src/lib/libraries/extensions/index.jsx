...
export default [
    ...
    },
    {
        name: (
            <FormattedMessage
                defaultMessage="ScratchIt"
                description="Name for the 'ScratchIt' extension"
                id="gui.extension.scratchbit.name"
            />
        ),
        ...
        description: (
            <FormattedMessage
                defaultMessage="Build with ScratchIt."
                description="Description for the 'ScratchIt' extension"
